...
rv = automate_supervised_dataset_generation.automate.parallel_scraping(query,num_page,labels,test_size=test_size,max_evals=max_evals,trial_timeout=trial_timeout,inference_size=inference_size)
